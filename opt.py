...
parser.add_argument('--outdir', dest='outputpath',
                    help='output-directory', default="/root/autodl-tmp/AlphaPose/dataset_processed14")
...
parser.add_argument('--inputdir', dest='datasetpath',
                    help='input-directory', default="/root/autodl-tmp/dataset/训练数据集") # TODO
parser.add_argument('--batchsize', type=int, default=1,
                    help='the size of video image processing at one time')
